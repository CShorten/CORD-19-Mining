...
<table>
  ...
  <tr>
    ...
    <th style = "color:blue;"> This notebook loads the sequences and labels stored in a DataFrame, tokenizes them, and feeds it to siamese transformers for similarity loss </th>
</table>
